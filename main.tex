...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/Ayaan_Singing.wav
\end{lstlisting}
\item 
\label{Python code}
...
\begin{figure}[!ht]
\centering
    \includegraphics[width=0.8\columnwidth]{figs/Audiobefore.png}
    \caption{Spectrogram of the audio file before Filtering}
    \label{fig:before_filter_plot}
\end{figure}
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\columnwidth]{figs/Audioafter.jpg}
...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
%
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/5.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/6.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
    ...
    &+b\brak{2}x\brak{n-2}+b\brak{3}x\brak{n-3} 
\end{align}
Difference Equation is given by :
\begin{align}
	&\brak{0.00175493}y(n) + \brak{0.00526479}y(n - 1) \nonumber\\ \
 & +\brak{0.00526479}y(n - 2) \nonumber \\
	&+ \brak{0.00175493}y(n - 3)  \nonumber \\
	&= x(n) - \brak{2.47782403}x(n - 1) \nonumber \\
	&+ \brak{2.0833474}x(n - 2) -\brak{0.59148392}x(n - 3) 
\end{align}
...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Ashraf-1508/Audio-Filter/blob/main/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\\
\solution The given butterworth filter is lowpass with order=3 and cutoff-frequency=2kHz.
